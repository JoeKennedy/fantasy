...
actionToSplitString Fight     = (" fight ", " ")
...
weightedScoringAttributes Insult    = (True,   5,   5,  -5,  -5)
weightedScoringAttributes Fight     = (True,  10,  10,  10,  10)
...
weightedScoringAttributes Bravery   = (True,   5,   5,   0,   0)
weightedScoringAttributes Cowardice = (True,   5,   5,   0,   0)
